  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 md:px-8 pt-20 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1503951914875-452162b0f3f1?q=80&w=2070')] bg-cover bg-center opacity-80 scale-110" />
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          >
            CORTE DE <br />
            <span className="text-stroke">RESPEITO</span>
          </motion.h1>
          ...
          >
            Visual alinhado, confiança em alta. <br />
            Para quem curte estilo moderno com atitude.
          </motion.p>
          ...
          >
            <a
              href="#agendamento"
              className="bw-button w-full sm:w-auto text-center"
            >
              Reservar Horário
            </a>
            <a
              href="#servicos"
              className="bw-button-outline w-full sm:w-auto text-center"
            >
              Ver Catálogo
            </a>
          </motion.div>
