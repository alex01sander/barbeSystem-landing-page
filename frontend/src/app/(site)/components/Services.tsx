...
export function Services() {
  ...
  return (
    <section id="servicos" className="relative py-24 md:py-40 px-6 md:px-8 bg-black border-y border-white/5 overflow-hidden">
      {/* Barbershop Background */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1585747860715-2ba37e788b70?q=80&w=2074')] bg-cover bg-fixed bg-center grayscale opacity-[0.06] mix-blend-luminosity" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-16 md:mb-32 text-center">
          <span className="text-[10px] font-bold uppercase tracking-[0.3em] md:tracking-[0.5em] text-zinc-500">The Menu</span>
            ...
            >
              ...
              <div className="pt-8 md:pt-12 border-t border-white/5 flex items-center justify-between">
                <div className="flex flex-col">
                  ...
                  <span className="text-xl md:text-2xl font-black font-display text-white italic">R$ {Number(service.price).toFixed(0)}</span>
                </div>
