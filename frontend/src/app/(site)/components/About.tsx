...
export function About() {
  return (
    <section
      id="sobre"
      className="relative py-24 md:py-40 px-6 md:px-8 bg-black overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center relative z-10">
        ...
        >
          ...
          <div className="font-body text-zinc-500 leading-relaxed text-sm md:text-lg space-y-6 md:space-y-8 max-w-xl uppercase tracking-wider">
            <p>
              IdalgoCortes vai além do corte. É experiência, imagem e confiança
              em cada detalhe.
            </p>
            <p className="text-white border-l border-white/20 pl-8 italic">
              "Não seguimos tendências. Criamos presença."
            </p>
            <p>Cada atendimento importa. Cada resultado fala por si.</p>
          </div>
        </motion.div>
        ...
        >
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1593702295094-ada74bc4a39d?q=80&w=2070')] bg-cover bg-center transition-transform duration-1000 group-hover:scale-110" />
